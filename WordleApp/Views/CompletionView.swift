...
struct CompletionView: View {
    ...
    var body: some View {
        VStack {
            Text(viewModelWordle.state.gameWon ? "Congratulations! You've guessed the word 👏" : "Game Over! The correct word was \(viewModelWordle.state.submittedWordValue?.last?.mastWord).")
                .font(.title)
                .padding()
